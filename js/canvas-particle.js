...
function canvasInit(canvasConfig){
	...
	// 获取特定div作为背景
	// large-header是你想要将其作为背景的div的ID
	var body = document.getElementById("large-header");
...
function canvasSize(canvas){
	...
	// 获取特定div的宽高
	var width = document.getElementById("large-header").style.width;
	var height = document.getElementById("large-header").style.height;
